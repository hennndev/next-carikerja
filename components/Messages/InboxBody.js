...
const InboxBody = ({messageTerm, isCreateMessage, setIsCreateMessage, isMsgSetting, handleCloseMsgSetting, handleMsgSetting, handleDeleteMessage}) => {
        ...
        <div className="mt-5 xl:mt-7 flex-1 flex justify-between flex-col">
            ...
            <div className="flex-between mt-10">
                ...
                <div className="relative">
                    {!isCreateMessage && (
                        <AiOutlineMore className="text-gray-500 text-xl cursor-pointer" onClick={(e) => handleMsgSetting(e, !isMsgSetting)}/>
                    )}
                    {isMsgSetting && (
                        <div className="dropdown w-[230px] mb-10 -top-[30px]">
                            ...
                            <div className="item" onClick={handleCloseMsgSetting}>
