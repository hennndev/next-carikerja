...
const PostDetail = ({data}) => {
    ...
    const checkCandidateExist = data?.data.kandidat.find(data => data.id === userLogin?._id)
    ...
    return (
        <>
            ...
            {isApply && <ApplyForm dataPost={data?.data} dataUserLogin={userLogin} handleClose={() => setIsApply(false)}/>}
            <PageContainer>
